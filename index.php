...
<!-- donate section -->
<div class="container-fluid" style="background-color: #E74C3C; height: 80vh; display: flex; align-items: center; justify-content: center; text-align: center; padding: 30px 0; margin-top: -5px">
    <div class="row">
        <div class="col-md-12">
